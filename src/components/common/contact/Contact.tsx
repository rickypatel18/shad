  ...
  return (
    ...
    >
      <div className="w-full flex justify-center ">
        <div className="w-full grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 mx-auto">
          {/* First div (1 column) */}
          <div
          ...
          >
            ...
            <div className="flex flex-col gap-[10px] w-full">
              ...
              <p className="text-[19px] md:text-[21px] lg:text-[24px] font-[400] text-primary">
                (303) 555-0105
              </p>
            </div>
          </div>

          {/* Third div (2 columns wide on small screens) */}
          <div
            className="group col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2 rounded-[8px] flex flex-col gap-[16px]"
            style={{ border: "1px solid #20B52633", padding: "20px" }}
          >
            <div className="relative flex justify-center items-center w-[56px] h-[60px]">
              <img
